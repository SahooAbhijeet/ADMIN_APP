...
const Vehicles = () => {
  return (
    <section>
      <div>
        <h1 className='text-secondary font-medium mt-10 mx-36 font-poppins text-5xl'>Vehicles
        </h1>


        <div className="lg:mx-36 md:mx-7 mx-8  h-screen  lg:-mt-48 -mt-40 flex items-center justify-center ">
