...
const Login = () => {
  return (
    <>
      <section className='mx-36 flex overflow-hidden'>
        <div className='absolute hidden lg:block'>
          ...
          <img src='https://storage.googleapis.com/papercycle_prod/recycle.svg' alt='container' width={750} height={100} className='mt-10 -mx-10 ' />
        </div>
        <h1 className='text-xl font-montserrat font-semibold mt-7 mx-[65%]'>Login</h1>
        <div className="bg-primary pt-10 pb-8 rounded-lg shadow-lg lg:-ml-[70%] md:-ml-[104%] -ml-[75%]  lg:mr-40 md:mr-40 mr-40 mb-52 mt-16 lg:w-[48%] md:w-[125%] w-full">

          <>
            <img src={Layer2} alt='Layer_2' className='mx-5 -mt-0' />
            <h1 className='text-2xl text-secondary  -mt-14 lg:pl-20 md:pl-20 pl-3 font-poppins font-semibold'>Welcome, <br /> Admin</h1>
            ...
            <button className='lg:py-3 py-2 mt-10 lg:mt-10 rounded-full bg-secondary text-white lg:ml-7 ml-3 mr-7 font-poppins font-medium vlg:w-[350px] md:w-3/4 w-11/12 md:ml-20'
            >
              Login
            </button>
          </>
      ...
      <div className="fixed -mt-40 bottom-0 left-0 w-full bg-tertiary flex flex-col items-center">
